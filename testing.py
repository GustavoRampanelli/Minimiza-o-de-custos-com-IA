# Inteligência Artificial aplicada a Negócios e Empresas - Caso Prático 2
# Fase de testes
...
# Executando uma simulação de um ano no modo de inferência
env.train = train
...
# IMPRIME OS RESULTADOS DO TREINAMENTO NO FIM DA ÉPOCA
print("\n")
